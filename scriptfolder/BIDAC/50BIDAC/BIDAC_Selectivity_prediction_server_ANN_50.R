...
model <- load_model_tf(paste("scriptfolder/BIDAC/50BIDAC/", j,"_", i,"_","BIGIDAC_NN_benchmark.tf", sep = ""), c('PReLU' = layer_activation_parametric_relu), compile = TRUE)
...
### export
write.csv(pred_test_df, file = paste("scriptfolder/BIDAC/50BIDAC/", j,"_","ts_pred_BIDAC.csv", sep = "") ) 
