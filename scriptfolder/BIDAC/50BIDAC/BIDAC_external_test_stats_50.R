...
df_pred <- read.csv(paste("scriptfolder/BIDAC/50BIDAC/", k, "_external_ts_pred_BIDAC.csv", sep = "" ) , 
 header=TRUE, check.names=FALSE,
...
write.csv(best_results_list, file = "scriptfolder/BIDAC/50BIDAC/29_stat_external.csv")
