...
some_path <- paste("scriptfolder/BIDAC/50BIDAC/", j,"_",i,"_","BIGIDAC_NN_50.tf", sep = "") 
...
write.csv(model_fitted_df, file = paste("scriptfolder/BIDAC/50BIDAC/", j,"_",i,"_", "BIGIDAC_model_fitted_df",".csv", sep = ""))
write.csv(model_fitted_min, file = paste("scriptfolder/BIDAC/50BIDAC/", j,"_",i,"_", "BIGIDAC_model_fitted_min",".csv", sep = ""))
