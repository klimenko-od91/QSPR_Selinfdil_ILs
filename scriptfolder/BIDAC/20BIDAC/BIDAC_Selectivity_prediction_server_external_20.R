...
model <- load_model_tf(paste("scriptfolder/BIDAC/20BIDAC/", j,"_", i,"_","BIGIDAC_NN_20.tf", sep = ""), c('PReLU' = layer_activation_parametric_relu), compile = TRUE)
...
### export
write.csv(pred_test_df, file = paste("scriptfolder/BIDAC/20BIDAC/", j,"_","external_ts_pred_Selectivity.csv", sep = "") ) 
