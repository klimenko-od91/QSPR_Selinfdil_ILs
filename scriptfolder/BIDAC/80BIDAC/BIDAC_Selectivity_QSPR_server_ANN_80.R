...
### setting aside the training set
...
some_path <- paste("scriptfolder/BIDAC/80BIDAC/", j,"_",i,"_","BIGIDAC_NN_benchmark.tf", sep = "") 
...
write.csv(model_fitted_df, file = paste("scriptfolder/BIDAC/80BIDAC/", j,"_",i,"_", "BIGIDAC_model_fitted_df",".csv", sep = ""))
write.csv(model_fitted_min, file = paste("scriptfolder/BIDAC/80BIDAC/", j,"_",i,"_", "BIGIDAC_model_fitted_min",".csv", sep = ""))
