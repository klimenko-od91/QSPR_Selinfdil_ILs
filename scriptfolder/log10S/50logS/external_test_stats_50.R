...
df_pred <- read.csv(paste("scriptfolder/log10S/50logS/", k, "_external_ts_pred_Selectivity.csv", sep = "" ) , 
 header=TRUE, check.names=FALSE,
...
### checking for potential training or test set compounds data.
...
write.csv(stat_vector, file = "scriptfolder/log10S/50logS/57_stat_external_no_AD_50.csv")
...
write.csv(stat_class, file = "scriptfolder/log10S/50logS/57_stat_class_external_no_AD_50.csv")
