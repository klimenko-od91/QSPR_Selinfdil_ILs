...
df_pred <- read.csv(paste("scriptfolder/log10S/50logS/", k, "_ts_pred_Selectivity.csv", sep = "" ) , 
 header=TRUE, check.names=FALSE,
...
save(mae_per_comp, file = "scriptfolder/log10S/50logS/mae_per_comp.R") 
...
write.csv(best_results_list, file = "scriptfolder/log10S/50logS/best_results_list.csv")
...
Trs_MAE <- read.csv(paste("scriptfolder/log10S/50logS/", k, "_", j, "_model_fitted_min.csv", sep = "" ) , 
 header=TRUE, check.names=FALSE,
                 as.is=TRUE,  row.names=1)

Val_MAE <- read.csv(paste("scriptfolder/log10S/50logS/", k, "_", j, "_model_fitted_df.csv", sep = "" ) , 
 header=TRUE, check.names=FALSE,
                 as.is=TRUE,  row.names=1)
...
write.csv(Internal_Val_stat, file = "scriptfolder/log10S/50logS/Selectivity_50_Internal_Val_stat.csv")
...
write.csv(stat_class, file = "scriptfolder/log10S/50logS/57_stat_class_test_no_AD.csv")
