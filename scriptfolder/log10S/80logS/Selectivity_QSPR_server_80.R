##### The calculations are done in R environment. All activated packagesmust be first installed and paths to files must be changed to the ones of your choosing.
...
some_path <- paste("scriptfolder/log10S/80logS/", j,"_",i,"_","Selectivity_NN_benchmark.tf", sep = "") 
...
write.csv(model_fitted_df, file = paste("scriptfolder/log10S/80logS/", j,"_",i,"_", "model_fitted_df",".csv", sep = ""))
write.csv(model_fitted_min, file = paste("scriptfolder/log10S/80logS/", j,"_",i,"_", "model_fitted_min",".csv", sep = ""))
