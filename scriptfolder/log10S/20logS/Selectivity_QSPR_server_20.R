...
some_path <- paste("scriptfolder/log10S/20logS/", j,"_",i,"_","Selectivity_NN_20.tf", sep = "") 
...
write.csv(model_fitted_df, file = paste("scriptfolder/log10S/20logS/", j,"_",i,"_", "model_fitted_df",".csv", sep = ""))
write.csv(model_fitted_min, file = paste("scriptfolder/log10S/20logS/", j,"_",i,"_", "model_fitted_min",".csv", sep = ""))
