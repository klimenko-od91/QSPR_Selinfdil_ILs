...
#j is an artifact from trying all models on the best test set
j = 20
...
model <- load_model_tf(paste("scriptfolder/log10S/20logS/", j,"_", i,"_","Selectivity_NN_20.tf", sep = ""), c('PReLU' = layer_activation_parametric_relu), compile = TRUE)
...
### export
write.csv(pred_test_df, file = paste("scriptfolder/log10S/20logS/", j,"_","external_ts_pred_Selectivity.csv", sep = "") ) 
